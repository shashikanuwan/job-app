<main class="flex flex-col justify-center bg-cyan-500 p-16">
    <h1 class="text-3xl font-bold text-white text-center">Edit job</h1>
        ...
        <form action="{{ route('jobs.update', $job) }}" method="POST">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                <div class="flex flex-col">
                    ...
                    <x-text-input type="text" name="title" id="title"  value="{{$job->title}}"
                ...
                <div class="flex flex-col">
                    ...
                    <x-text-input type="date" id="expiry_date" name="expiry_date"  value="{{$job->expiry_date}}"
                        class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40" />
                </div>
            </div>
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                <div class="flex flex-col">
                    ...
                    <x-text-input type="number" id="minimum_salary" name="minimum_salary"  value="{{$job->minimum_salary}}"
                        class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40" />
                </div>
                <div class="flex flex-col">
                    <label for="maximum_salary" class="mb-2 font-semibold">Maximum Salary (LKR) <span class="text-red-500">*</span></label>
                    <x-text-input type="number" id="maximum_salary" name="maximum_salary"  value="{{$job->maximum_salary}}"
                        class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40" />
                </div>
            </div>
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                <div class="flex flex-col">
                    ...
                    <select name="sub_category_id" id="sub_category_id"
                        class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40">
                        <option selected value="{{$job->sub_category_id}}">{{$job->subCategory->name}}</option>
                ...
                <div class="flex flex-col">
                    ...
                    <select name="district_id" id="district_id"
                        class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40">
                        <option selected value="{{$job->district_id}}">{{$job->district->name}}</option>
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                <div class="flex flex-col">
                    ...
                    <select name="work_location_id" id="work_location_id"
                        class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40">
                        <option selected value="{{$job->work_location_id}}">{{$job->workLocation->name}}</option>
                ...
                <div class="flex flex-col">
                    ...
                    <select name="employment_type_id" id="employment_type_id"
                        class="w-full max-w-lg rounded-lg border border-slate-200 px-2 py-1 hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/40 active:ring active:ring-blue-500/40">
                        <option selected value="{{$job->employment_type_id}}">{{$job->employmentType->name}}</option>
